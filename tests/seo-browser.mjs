...
try{
  ...
  const home=await (await context.request.get(`${baseUrl}/ko`)).text();const toolCount=(home.match(/href="\/ko\/tools\//g)??[]).length;const expectedUrlCount=(toolCount+1)*3;
  ...
  for(const [locale,path] of [["ko","word-counter"],["en","json-formatter"],["ja","image-color-picker"],["ko","screenshot-stitcher"],["en","privacy-redactor"]]){
