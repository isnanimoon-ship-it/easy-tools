...
const categories = [
  ...
  { key: "developer", icon: Code2, tools: [["/tools/json-formatter", "jsonFormatter"], ["/tools/base64-converter", "base64Converter"], ["/tools/url-encoder-decoder", "urlEncoderDecoder"], ["/tools/regex-tester", "regexTester"], ["/tools/cron-expression-generator", "cronExpressionGenerator"], ["/tools/qr-code-generator", "qrCodeGenerator"]] },
  { key: "media", icon: Images, tools: [["/tools/image-compressor", "imageCompressor"], ["/tools/image-color-picker", "imageColorPicker"], ["/tools/youtube-thumbnail-downloader", "youtubeThumbnailDownloader"]] },
